...
uint8_t DISCONNECT[] = {0x01, 0x06, 0x04, 0x3}; // TODO - fill this in
...
uint8_t ACI_GAP_SET_NON_DISCOVERABLE_COMPLETE[] = {0x04, 0x0e, 0x4, 0x1, 0x81, 0xFC, 0x00}; // TODO - fill this in
